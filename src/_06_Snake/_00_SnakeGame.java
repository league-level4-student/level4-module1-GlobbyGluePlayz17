...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Snake Game \nUse the arrow keys to move a \"snake\" around the screen. \nDuring the game, you must navigate the snake to \"eat\" \n(hit) the food and thereby grow larger. However, \nthe game ends when the snake either moves off \nthe screen or collides into itself. The goal is to make \nthe snake as large as possible before that happens.";
...
//		snake.setDirection(Direction.RIGHT);
	...
	private void gameOver() {
		...
		String userinput = JOptionPane.showInputDialog("Play Again? YES or NO");
